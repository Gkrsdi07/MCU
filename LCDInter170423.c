...
int main(void)
{
  ...
  {
    /* USER CODE END WHILE */
	    lcd_cmd(0x80);                          //where to display Hello World, C0(2nd row) is starting address
	  	lcd_display("Hello World! G07",16);
	  	lcd_cmd(0xc0);							//where to display Hello World, C0(2nd row) is starting address
	  	lcd_display("Welcome to SDI",14);
